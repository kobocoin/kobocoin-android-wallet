...
public class GenericUtilsTest
{
	...
	public void formatValue() throws Exception
	{
		...
		assertEquals("350000000.00", GenericUtils.formatValue(NetworkParameters.MAX_MONEY, 6, 0));
	}

	@Test
	public void formatMHTML5Value() throws Exception
	{
		...
		assertEquals("350000000000.00", GenericUtils.formatValue(NetworkParameters.MAX_MONEY, 3, 3));
	}

	@Test
	public void formatUHTML5Value() throws Exception
	{
		final BigInteger coin = new BigInteger("100000000");
		...
		assertEquals("350000000000000", GenericUtils.formatValue(NetworkParameters.MAX_MONEY, 2, 6));
	}
}
