...
package com.bushstar.kobocoin_android_wallet;
...
public class Configuration
{
	...
	public static final String PREFS_KEY_HTML5_PRECISION = "html5_precision";
	...
	private static final int PREFS_DEFAULT_HTML5_SHIFT = 0;
	private static final int PREFS_DEFAULT_HTML5_PRECISION = 2;
	...
	public boolean hasHTML5Precision()
	{
		return prefs.contains(PREFS_KEY_HTML5_PRECISION);
	}

	public int getHTML5Precision()
	{
		final String precision = prefs.getString(PREFS_KEY_HTML5_PRECISION, null);
		if (precision != null)
			return precision.charAt(0) - '0';
		else
			return PREFS_DEFAULT_HTML5_PRECISION;
	}

	public int getHTML5MaxPrecision()
	{
		final int HTML5Shift = getHTML5Shift();

		if (HTML5Shift == 0)
			return Constants.HTML5_MAX_PRECISION;
		else if (HTML5Shift == 3)
			return Constants.MHTML5_MAX_PRECISION;
		else
			return Constants.UHTML5_MAX_PRECISION;
	}

	public int getHTML5Shift()
	{
		final String precision = prefs.getString(PREFS_KEY_HTML5_PRECISION, null);
		if (precision != null)
			return precision.length() == 3 ? precision.charAt(2) - '0' : 0;
		else
			return PREFS_DEFAULT_HTML5_SHIFT;
	}

	public String getHTML5Prefix()
	{
		final int HTML5Shift = getHTML5Shift();

		if (HTML5Shift == 0)
			return Constants.CURRENCY_CODE_HTML5;
		else if (HTML5Shift == 3)
			return Constants.CURRENCY_CODE_MHTML5;
		else
			return Constants.CURRENCY_CODE_UHTML5;
	}
