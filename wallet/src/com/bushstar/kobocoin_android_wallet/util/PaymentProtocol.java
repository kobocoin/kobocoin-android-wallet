...
import org.kobocoin.protocols.payments.Protos;
...
import com.bushstar.kobocoinj.protocols.payments.PaymentSession;
import com.bushstar.kobocoinj.protocols.payments.PaymentSession.PkiVerificationData;
...
{
	public static final String MIMETYPE_PAYMENTREQUEST = "application/kobocoin-paymentrequest"; // BIP 71
	public static final String MIMETYPE_PAYMENT = "application/kobocoin-payment"; // BIP 71
	public static final String MIMETYPE_PAYMENTACK = "application/kobocoin-paymentack"; // BIP 71
			...
			@Nullable final BigInteger refundAmount, @Nullable final String memo, @Nullable final byte[] merchantData)
	{
		...
		builder.addTransactions(ByteString.copyFrom(transaction.unsafeKobocoinSerialize()));
