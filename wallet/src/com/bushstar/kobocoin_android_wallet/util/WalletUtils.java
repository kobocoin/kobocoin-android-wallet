...
package com.bushstar.kobocoin_android_wallet.util;
...
import com.bushstar.kobocoinj.core.ScriptException;
import com.bushstar.kobocoinj.core.Sha256Hash;
import com.bushstar.kobocoinj.core.Transaction;
import com.bushstar.kobocoinj.core.TransactionInput;
import com.bushstar.kobocoinj.core.TransactionOutput;
...
public class WalletUtils
{
	...
	public static BigInteger localValue(@Nonnull final BigInteger HTML5Value, @Nonnull final BigInteger rate)
	{
		return HTML5Value.multiply(rate).divide(GenericUtils.ONE_HTML5);
	}

	public static BigInteger HTML5Value(@Nonnull final BigInteger localValue, @Nonnull final BigInteger rate)
	{
		return localValue.multiply(GenericUtils.ONE_HTML5).divide(rate);
	}
	...
	public static void writeKeys(@Nonnull final Writer out, @Nonnull final List<ECKey> keys) throws IOException
	{
		...
		out.write("# KEEP YOUR PRIVATE KEYS SAFE! Anyone who can read this can spend your Kobocoins.\n");
