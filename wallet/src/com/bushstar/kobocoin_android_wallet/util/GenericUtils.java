...
{
	public static final BigInteger ONE_HTML5 = new BigInteger("100000000", 10);
	public static final BigInteger ONE_MHTML5 = new BigInteger("100000", 10);
	public static final BigInteger ONE_UHTML5 = new BigInteger("100", 10);

	private static final int ONE_HTML5_INT = ONE_HTML5.intValue();
	private static final int ONE_MHTML5_INT = ONE_MHTML5.intValue();
	private static final int ONE_UHTML5_INT = ONE_UHTML5.intValue();
			...
			final int precision, final int shift)
	{
		...
		if (shift == 0)
		{
			...
			final long coins = absValue / ONE_HTML5_INT;
			final int satoshis = (int) (absValue % ONE_HTML5_INT);
		...
		else if (shift == 3)
		{
			...
			final long absValue = Math.abs(longValue);
			final long coins = absValue / ONE_MHTML5_INT;
			final int satoshis = (int) (absValue % ONE_MHTML5_INT);
		...
		else if (shift == 6)
		{
			...
			final long absValue = Math.abs(longValue);
			final long coins = absValue / ONE_UHTML5_INT;
			final int satoshis = (int) (absValue % ONE_UHTML5_INT);
	...
	{
		return formatValue(value, Constants.HTML5_MAX_PRECISION, 0);
	}
