...
import com.bushstar.kobocoinj.core.AbstractPeerEventListener;
import com.bushstar.kobocoinj.core.Address;
import com.bushstar.kobocoinj.core.Block;
import com.bushstar.kobocoinj.core.BlockChain;
import com.bushstar.kobocoinj.core.CheckpointManager;
import com.bushstar.kobocoinj.core.Peer;
import com.bushstar.kobocoinj.core.PeerEventListener;
import com.bushstar.kobocoinj.core.PeerGroup;
...
import com.bushstar.kobocoinj.core.WalletEventListener;
import com.bushstar.kobocoinj.net.discovery.DnsDiscovery;
import com.bushstar.kobocoinj.net.discovery.PeerDiscovery;
import com.bushstar.kobocoinj.net.discovery.PeerDBDiscovery;
import com.bushstar.kobocoinj.net.discovery.PeerDiscoveryException;
import com.bushstar.kobocoinj.store.BlockStore;
import com.bushstar.kobocoinj.store.BlockStoreException;
import com.bushstar.kobocoinj.store.SPVBlockStore;
import com.bushstar.kobocoinj.store.ValidHashStore;
...
import com.bushstar.kobocoin_android_wallet.WalletBalanceWidgetProvider;
import com.bushstar.kobocoin_android_wallet.ui.WalletActivity;
import com.bushstar.kobocoin_android_wallet.util.CrashReporter;
import com.bushstar.kobocoin_android_wallet.util.GenericUtils;
import com.bushstar.kobocoin_android_wallet.util.ThrottlingWalletChangeListener;
...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
	...
	private void notifyCoinsReceived(@Nullable final Address from, @Nonnull final BigInteger amount)
	{
		...
		final String tickerMsg = getString(R.string.notification_coins_received_msg,
				HTML5Prefix + ' ' + GenericUtils.formatValue(amount, HTML5Precision, HTML5Shift))
				+ msgSuffix;

		final String msg = getString(R.string.notification_coins_received_msg,
				HTML5Prefix + ' ' + GenericUtils.formatValue(notificationAccumulatedAmount, HTML5Precision, HTML5Shift))
				+ msgSuffix;
