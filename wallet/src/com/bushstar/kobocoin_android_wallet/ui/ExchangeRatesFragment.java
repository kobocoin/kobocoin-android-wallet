...
public final class ExchangeRatesFragment extends SherlockListFragment implements OnSharedPreferenceChangeListener
{
	...
	{
		if (Configuration.PREFS_KEY_EXCHANGE_CURRENCY.equals(key) || Configuration.PREFS_KEY_HTML5_PRECISION.equals(key))
		{
			defaultCurrency = config.getExchangeCurrencyCode();
	...
	private void updateView()
	{
		...
		if (adapter != null)
		{
			...
			final BigInteger base = HTML5Shift == 0 ? GenericUtils.ONE_HTML5 : GenericUtils.ONE_MHTML5;
	...
	{
		private BigInteger rateBase = GenericUtils.ONE_HTML5;
