...
import org.kobocoin.protocols.payments.Protos.Payment;
...
import com.bushstar.kobocoinj.core.AddressFormatException;
import com.bushstar.kobocoinj.core.ECKey;
import com.bushstar.kobocoinj.core.NetworkParameters;
import com.bushstar.kobocoinj.core.Sha256Hash;
import com.bushstar.kobocoinj.core.Transaction;
import com.bushstar.kobocoinj.core.TransactionConfidence;
import com.bushstar.kobocoinj.core.TransactionConfidence.ConfidenceType;
import com.bushstar.kobocoinj.core.Wallet;
import com.bushstar.kobocoinj.core.Wallet.BalanceType;
import com.bushstar.kobocoinj.core.Wallet.SendRequest;

import com.bushstar.kobocoin_android_wallet.AddressBookProvider;
import com.bushstar.kobocoin_android_wallet.Configuration;
import com.bushstar.kobocoin_android_wallet.Constants;
import com.bushstar.kobocoin_android_wallet.ExchangeRatesProvider;
...
import com.bushstar.kobocoin_android_wallet.data.PaymentIntent;
import com.bushstar.kobocoin_android_wallet.data.PaymentIntent.Standard;
import com.bushstar.kobocoin_android_wallet.integration.android.KobocoinIntegration;
import com.bushstar.kobocoin_android_wallet.offline.DirectPaymentTask;
import com.bushstar.kobocoin_android_wallet.ui.InputParser.BinaryInputParser;
import com.bushstar.kobocoin_android_wallet.ui.InputParser.StreamInputParser;
import com.bushstar.kobocoin_android_wallet.ui.InputParser.StringInputParser;
import com.bushstar.kobocoin_android_wallet.util.Bluetooth;
import com.bushstar.kobocoin_android_wallet.util.GenericUtils;
import com.bushstar.kobocoin_android_wallet.util.Nfc;
import com.bushstar.kobocoin_android_wallet.util.PaymentProtocol;
...
public final class SendCoinsFragment extends SherlockFragment
{
	...
	public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState)
	{
		...
		final CurrencyAmountView HTML5AmountView = (CurrencyAmountView) view.findViewById(R.id.send_coins_amount_html5);
		...
		new SendCoinsOfflineTask(wallet, backgroundHandler)
		{
			...
			protected void onSuccess(final Transaction transaction)
			{
				...
				if (callingActivity != null)
				{
					...
					KobocoinIntegration.transactionHashToResult(result, sentTransaction.getHashAsString());
					if (paymentIntent.standard == Standard.BIP70)
						KobocoinIntegration.paymentToResult(result, payment.toByteArray());
				...
				if (missing != null)
					msg.append(
							getString(R.string.send_coins_fragment_insufficient_money_msg1,
									HTML5Prefix + ' ' + GenericUtils.formatValue(missing, HTML5Precision, HTML5Shift))).append("\n\n");
				if (pending.signum() > 0)
					msg.append(
							getString(R.string.send_coins_fragment_pending,
									HTML5Prefix + ' ' + GenericUtils.formatValue(pending, HTML5Precision, HTML5Shift))).append("\n\n");
	...
	{
		final BigInteger available = wallet.getBalance(BalanceType.ESTMINUSFEE);

		amountCalculatorLink.setHTML5Amount(available);
	...
	private void updateView()
	{
		if (paymentIntent != null)
		{
			...
			if (sentTransaction != null)
			{
				final int HTML5Precision = config.getHTML5Precision();
				final int HTML5Shift = config.getHTML5Shift();

				sentTransactionView.setVisibility(View.VISIBLE);
				sentTransactionListAdapter.setPrecision(HTML5Precision, HTML5Shift);
	...
	private void initStateFromKobocoinUri(@Nonnull final Uri kobocoinUri)
	{
		final String input = kobocoinUri.toString();
	...
	private void initStateFromIntentUri(@Nonnull final String mimeType, @Nonnull final Uri kobocoinUri)
	{
		try
		{
			final InputStream is = contentResolver.openInputStream(kobocoinUri);
	...
	private void updateStateFrom(final @Nonnull PaymentIntent paymentIntent)
	{
		...
		handler.post(new Runnable()
		{
			...
			public void run()
			{
				if (state == State.INPUT)
				{
					amountCalculatorLink.setHTML5Amount(paymentIntent.getAmount());
