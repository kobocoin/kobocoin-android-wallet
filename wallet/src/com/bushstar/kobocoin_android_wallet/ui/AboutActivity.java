...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_KOBOCOINJ = "about_credits_kobocoinj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_KOBOCOINJ).setTitle(getString(R.string.about_credits_kobocoinj_title, VersionMessage.KobocoinJ_VERSION));
		findPreference(KEY_ABOUT_CREDITS_KOBOCOINJ).setSummary(Constants.CREDITS_KOBOCOINJ_URL);
	...
	public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen, final Preference preference)
	{
		...
		else if (KEY_ABOUT_CREDITS_KOBOCOINJ.equals(key))
		{
			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.CREDITS_KOBOCOINJ_URL)));
			finish();
		}
