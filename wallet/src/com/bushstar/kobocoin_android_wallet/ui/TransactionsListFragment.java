...
import com.bushstar.kobocoinj.core.Transaction.Purpose;
...
public class TransactionsListFragment extends SherlockListFragment implements LoaderCallbacks<List<Transaction>>, OnSharedPreferenceChangeListener
{
	...
	private static final Uri KEY_ROTATION_URI = Uri.parse("http://kobocoin.org/en/alert/2013-08-11-android");
	...
	{
		if (Configuration.PREFS_KEY_HTML5_PRECISION.equals(key))
			updateView();
	}
	...
	private void updateView()
	{
		...
		adapter.setPrecision(HTML5Precision, HTML5Shift);
		adapter.clearLabelCache();
	}
}
