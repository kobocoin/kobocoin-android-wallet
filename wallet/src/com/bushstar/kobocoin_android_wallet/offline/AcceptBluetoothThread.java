...
package com.bushstar.kobocoin_android_wallet.offline;
...
import org.kobocoin.protocols.payments.Protos.PaymentACK;
...
public abstract class AcceptBluetoothThread extends Thread
{
	...
	protected static BluetoothServerSocket listen(final BluetoothAdapter adapter, final UUID uuid)
	{
		try
		{
			return adapter.listenUsingInsecureRfcommWithServiceRecord("Kobocoin Transaction Submission", uuid);
		}
		catch (final IOException x)
		{
