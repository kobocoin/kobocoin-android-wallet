...
import com.bushstar.kobocoinj.params.MainNetParams;
...
public class Constants
{
	...
	public static final String EXPLORE_BASE_URL = "http://dns2.kobocoin.com:8080/";

	public static final String MIMETYPE_TRANSACTION = "application/x-html5tx";
	...
	public static final String CURRENCY_CODE_HTML5 = "KOBO";
	public static final String CURRENCY_CODE_MHTML5 = "MANILLA";
	public static final String CURRENCY_CODE_UHTML5 = "COWRIE";
	...
	public static final int HTML5_MAX_PRECISION = 8;
	public static final int MHTML5_MAX_PRECISION = 5;
	public static final int UHTML5_MAX_PRECISION = 2;
	public static final int LOCAL_PRECISION = 8;

	public static final String DONATION_ADDRESS = "FFXsRuAAYKSz4FwkyXk9C86bCfdhpoKJ4n";
	...
	public static final String MARKET_PUBLISHER_URL = "market://search?q=pub:\"Kobocoin+Developers\"";
