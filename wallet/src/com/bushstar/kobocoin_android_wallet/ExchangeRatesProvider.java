...
import com.bushstar.kobocoinj.core.Utils;
...
public class ExchangeRatesProvider extends ContentProvider
{
	...
	private static final String BTCE_SOURCE = "bittrex.com";

	// https://bitmarket.eu/api/ticker

	static {
		try {
			BTCE_URL = new URL("http://bittrex.com/api/v1.1/public/getticker?market=btc-kobo");
